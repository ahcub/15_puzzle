...
class FifteenPuzzle:
    def __init__(self, input_reader, output_writer):
        self.model = Model()
        self.view = View(input_reader, output_writer)
        self.input_reader = input_reader

    def play(self):
        self.view.read_user_input('press enter to start the game')
    ...
    def read_tile_number_to_move(self):
        user_input = self.view.read_user_input('enter tile_number number to move: ')
